                ...
                detail: {
                    listener: "message", event: {
                        ...
                        data: {
                            ...
                            channel: channelName,
                            text: "Hola, no olvides suscribirte y activar las notificaciones",
                            isAction: !1,
                            emotes: [{
                                type: "twitch",
                                name: "Kappa",
                        ...
                        renderedText: 'Hola, no olvides suscribirte y activar las notificaciones <img src="https://static-cdn.jtvnw.net/emoticons/v1/25/1.0" srcset="https://static-cdn.jtvnw.net/emoticons/v1/25/1.0 1x, https://static-cdn.jtvnw.net/emoticons/v1/25/1.0 2x, https://static-cdn.jtvnw.net/emoticons/v1/25/3.0 4x" title="Kappa" class="emote">'
                    }
                }
            });
